          ...
          <div className="bg-white p-8 rounded-lg shadow-lg">
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <button
                ...
                className="w-full bg-blue-600 hover:bg-blue-700 disabled:bg-blue-400 text-white px-6 py-3 rounded-lg font-medium transition-all duration-300 flex items-center justify-center gap-2"
              >
                {isSubmitting ? (
          ...
          <div className="space-y-8">
            <div>
              ...
              <p className="text-gray-600 leading-relaxed mb-8">
                ...
                Whether you have a question about my work, want to collaborate, or just want to 
